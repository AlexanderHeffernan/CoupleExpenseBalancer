...
<template>
    <div class="fixed top-0 right-0 z-10 rounded-b-[40px] overflow-hidden transition-all duration-500" :class="isAccountPageOpen ? 'w-screen h-screen' : 'w-0 h-0'">
        <div class="absolute top-0 right-0 w-screen h-screen bg-accent">
            <p>Account Page</p>
            <button @click="closeAccountPage" class="absolute right-0 top-0 pt-5 transition-transform ease rounded-t-3xl w-20 flex justify-center items-center">
            ...
            <button @click="logoutButton">Sign out</button>
        </div>
    </div>
</template>