...
import { transactions, getUserDeficit, getBalance, addTransaction, handleBalanceConfirmed } from './utils/transactions.js';
...
<template>
    ...
    <div class="w-screen h-screen bg-background overflow-y-hidden">
        ...
        <div class="navbar flex fixed bottom-0 left-0 w-full h-20 bg-accent rounded-t-3xl">
            ...
            <!-- Balance button -->
            <button class="transition-transform ease relative rounded-t-3xl w-20 flex justify-center items-center" :class="getPage() === 'balance' ? '-translate-y-5 bg-primary' : ''" @click="changePage('balance')">
