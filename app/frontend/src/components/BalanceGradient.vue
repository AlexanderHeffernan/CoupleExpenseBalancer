...
<template>
    <div style="border: 16px solid #FFCCCC; flex: 1;" class="max-h-64 min-h-52 mb-5 aspect-square rounded-full" :style="{ background: `linear-gradient(to right, #FF6B6B ${getBalancePoint()}%, #A9A9A9 0%)` }">
