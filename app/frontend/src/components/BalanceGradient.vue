...
<template>
    <div style="border: 16px solid #FFCCCC;" class="max-h-64 min-h-52 mb-5 aspect-square flex-grow rounded-full" :style="{ background: `linear-gradient(to right, #FF6B6B ${getBalancePoint()}%, #A9A9A9 0%)` }">
